...
const MyShopItem = ({ title, item: { name, imageUrl, price, id }, history, match }) => {
...
MyShopItem.propTypes={
  ...
  item:PropTypes.arrayOf(PropTypes.oneOfType(PropTypes.string,PropTypes.number,PropTypes.boolPropTypes.string,PropTypes.number,PropTypes.bool)).isRequired,
